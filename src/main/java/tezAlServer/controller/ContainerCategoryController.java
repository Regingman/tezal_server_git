...
public class ContainerCategoryController {
    ...
    @GetMapping
    public ResponseEntity<List<ContainerCategoryDto>> List(){
        return ResponseEntity.ok(containerCategoryMapper.toContainerCategoryDtos(containerCategoryService.findAll()));
    }
